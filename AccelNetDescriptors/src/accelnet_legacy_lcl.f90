...
module accelnet_legacy_lcl
    ...
    real(real64), parameter, private :: PI = 3.1415926535897931d0

    !--------------------------------------------------------------------!

    logical, private :: pbc
    real(real64), dimension(3, 3), private :: latticeVec
    real(real64), dimension(3, 3), private :: gridVec
    integer, private :: nAtoms
    integer, dimension(:), pointer, private :: atomType
    real(real64), dimension(:, :), pointer, private :: cooLatt

    real(real64), private :: r_min
    real(real64), private :: r_max
...
contains
    ...
    subroutine lcl_init(r_min_in, r_max_in, latticeVec_in, &
        ...
        real(real64), intent(in) :: r_min_in
        real(real64), intent(in) :: r_max_in
        real(real64), dimension(3, 3), intent(in) :: latticeVec_in
        integer, intent(in) :: nAtoms_in
        integer, dimension(nAtoms_in), target, intent(in) :: atomType_in
        real(real64), dimension(3, nAtoms_in), target, intent(in) :: cooLatt_in
    ...
    function lcl_nmax_nbdist(rmin, rmax) result(nmax)
        ...
        real(real64), intent(in) :: rmin, rmax
        integer :: nmax

        real(real64) :: V_atom, V_cut
    ...
    subroutine lcl_nbdist(iatom, nnb, nbcoo, nbdist, r_cut, itype_opt, stat)
        ...
        integer, intent(in) :: iatom
        integer, intent(inout) :: nnb
        real(real64), dimension(3, nnb), intent(out) :: nbcoo
        real(real64), dimension(nnb), intent(out) :: nbdist
        real(real64), optional, intent(in) :: r_cut
        ...
        integer :: iat, iT
        integer :: itype
        real(real64) :: Rc, Rc2, dist2
        real(real64), dimension(3) :: coo2, cart
    ...
    subroutine lcl_nbdist_cart(iatom, nnb, nbcoo, nbdist, r_cut, itype_opt, &
        ...
        integer :: itype
        real(real64) :: Rc, Rc2, dist2
        real(real64), dimension(3) :: coo1, coo2, cart
        integer :: nblist_stat
    ...
    subroutine cell_assign_atoms(nc, nAtoms, cooLatt, cell, atomList, &
        ...
        real(real64), dimension(3, nAtoms), intent(inout) :: cooLatt
    ...
    subroutine cell_multiples(r_max, latticeVec, gridVec, nCells)
        ...
        real(real64), dimension(3, 3), intent(in) :: latticeVec
        real(real64), dimension(3, 3), intent(out) :: gridVec
        integer, dimension(3), intent(out) :: nCells

        real(real64), dimension(3) :: v
        real(real64), dimension(3) :: h
        real(real64) :: h_min
        real(real64) :: r
    ...
    function cell_get(coo, nc) result(ic)
        ...
        real(real64), dimension(3), intent(in) :: coo
        integer, dimension(3), intent(in) :: nc
        integer, dimension(3) :: ic
...
!!$  end subroutine cell_del
    ...
    subroutine wrap_cooLatt(coo)
        ...
        real(real64), dimension(3), intent(inout) :: coo
    ...
    function cell_volume(avec) result(V)
        ...
        real(real64), dimension(3, 3), intent(in) :: avec
        real(real64) :: V
    ...
    subroutine inner_sphere(avec, r, c)
        ...
        real(real64), dimension(3), optional, intent(out) :: c
    ...
    function sphere_supercell(avec, r) result(n)
        ...
        real(real64) :: V
        real(real64), dimension(3, 3) :: bvec
        real(real64), dimension(3) :: blen

        real(real64), parameter :: EPS = 0.001d0
    ...
    function cell_distance_squared(T, avec) result(dist)
        ...
        real(real64), dimension(3) :: dT, v1, v2, normal, h1, h2, d
        real(real64) :: d1, d2
    ...
    subroutine translation_vectors(Rc, avec, nT, T, Tnorm, nc, pbc)
        ...
        real(real64), dimension(nT), optional, intent(out) :: Tnorm
        ...
        integer :: i1, i2, i3
        real(real64) :: Rc2
        real(real64) :: cell_dist
        real(real64), dimension(3) :: v1, v2
        real(real64) :: vnorm
        integer, dimension(3) :: n
        ...
        real(real64), dimension(:), allocatable, target :: Tnorm1_tgt1, Tnorm1_tgt2
        real(real64), dimension(:), pointer :: Tnorm1
...
end module accelnet_legacy_lcl
